const projects = [
  {
    name: "FullStack MERN GraphQL Social Network",
  ...
  {
    name: "Virtual Wallet Go, gRPC, Microservices",
    url: "https://github.com/Marlos-Rodriguez/Go-Microservice-Virtual-Wallet",
    description:
  ...
  {
    name: "Hotel Website with Gatsby",
  ...
  {
    name: "To-dos application with Django",
